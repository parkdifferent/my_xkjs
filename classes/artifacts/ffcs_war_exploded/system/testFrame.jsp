            ...
            <div class="left_box">
                ...
                <div class="left_ul">
                    <ul class="ulleft" id="common_operation" style="display:block">
                        ...
                        <li><a href="javascript:void(0);" id="set_site_op_q" onclick="openURL('url','<%--<%=basePath%>/admin/set_site.htm--%><%=basePath%>/system/elecTextAction_home.do','main_workspace','set_site_op_q')"><img src="<%=basePath%>/resources/style/system/manage/blue/images/menu_empty.gif" width="5" height="9" /><span>用户管理</span></a></li>
