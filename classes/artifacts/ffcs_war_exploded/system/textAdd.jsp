...
<form name="Form1" id="Form1" method=post>
	...
	　 
		...
		<%-- <form action="${pageContext.request.contextPath }/system/elecTextAction_home.do" method="post">
			<input type="button" name="" value="查询"  id="" style="font-size:12px; color:black; height=20;width=50">
		</form> --%>
		
	<a href="${pageContext.request.contextPath }/system/elecTextAction_home.do">查询</a>
		
		<s:if test="#request.textList!=null && #request.textList.size()>0">
								<s:iterator value="#request.textList" var="text">
									<tr>
										<td><s:property value="#text.textName"/></td>
										<td><s:property value="#text.textDate"/></td>
										<td><s:property value="#text.textRemark"/></td>
									</tr>
