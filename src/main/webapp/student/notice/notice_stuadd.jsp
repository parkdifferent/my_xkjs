...
<head>
    ...
    <script type="text/javascript">
        ...
        function downloadFile() {
            ...
            window.location.href="<%=basePath%>/system/notice_download.do?noticeId=<s:property value='#request.notice.noticeId'/>";
        }
...
<div class="cont">
    <h1 class="seth">竞赛新闻</h1>
    <div class="nav_list">
        <ul>
            <li><a href="<%=basePath%>/system/notice_stulist.do"><b>主页</b></a> </li>
    ...
    <form name="theForm" id="theForm" action="<%=basePath%>/system/notice_save.do" method="post" enctype="multipart/form-data">
        ...
        <input name="title" type="text" id="title" value="<s:property value="#request.notice.title"/>" readonly/>
      </span></li>
                </ul>
      ...
      <input name="noticeTime" type="text" id="noticeTime" value="<s:date name='#request.notice.noticeTime' format='yyyy-MM-dd'/>"  readonly="readonly"/>
                ...
                <ul class="set1">
                    ...
                    <li><span class="webname">
        <input name="publisher" type="text" id="publisher" value="<s:property value="#request.notice.publisher"/>" readonly/>
      </span></li>
                </ul>
        ...
        <input name="fileName" type="text" id="fileName" value="<s:property value="#request.notice.fileName"/>" />
                ...
                <ul class="set1">
                   ...
                   <%-- <li><span> <input id="upload" type="file" name="upload" /></span></li>--%>
                </ul>
