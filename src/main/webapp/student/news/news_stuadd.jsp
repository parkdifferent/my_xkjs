...
<div class="cont">
    ...
    <div class="nav_list">
        <ul>
            <li><a href="<%=basePath%>/system/news_stulist.do"><b>主页</b></a> </li>
    ...
    <form name="theForm" id="theForm" action="<%=basePath%>/system/news_save.do" method="post">
        ...
        <input name="title" type="text" id="title"  value="<s:property value="#request.news.title"/>" readonly/>
      </span></li>
                </ul>
      ...
      <input name="newsTime" type="text" id="newsTime" value="<s:date name='#request.news.newsTime' format='yyyy-MM-dd'/>"  readonly/>
                ...
                <ul class="set1">
                    ...
                    <li><span class="webname">
        <input name="publisher" type="text" id="publisher" value="<s:property value="#request.news.publisher"/>" readonly/>
      </span></li>
                </ul>
