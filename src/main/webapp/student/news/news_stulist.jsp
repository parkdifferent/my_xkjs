...
<div class="cont">
    ...
    <form action="<%=basePath%>/system/news_stulist.do" method="post" name="ListForm" id="ListForm">
        <div class="search">
            <ul>
                <li>
                ...
                <s:if test="#request.newsList!=null && #request.newsList.size()>0">
                    <s:iterator value="#request.newsList" var="news">
                        <tr>
                            ...
                            <td align="center"><a href="<%=basePath%>/system/news_stuedit.do?newsId=<s:property value='#news.newsId'/>">点击查看</a>   </td>

                            <td align="center"><s:date name="#news.newsTime" format="yyyy-MM-dd"/></td>
                            <td align="center"><s:property value="#news.publisher"/></td>


                            <td align="center" class="hui oprate_con" style="min-width:80px"><a href="<%=basePath%>/system/news_stuedit.do?newsId=<s:property value='#news.newsId'/>&currentPage=${request.currentPage}" class="blue" >查看</a>
