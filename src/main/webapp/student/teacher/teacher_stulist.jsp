...
<body>
<div class="cont">
    <h3 class="seth">指导教师</h3>
    <div class="nav_list">
        <ul>
            <li><a href="<%=basePath%>/system/teacher_stulist.do"  class="this"><b>主页</b></a> </li>
            <%-- <li><a href="<%=basePath%>/system/teacher_add.do" ><b>新增</b></a></li>--%>

        </ul>
    </div>
    <form action="<%=basePath%>/system/teacher_stulist.do" method="post" name="ListForm" id="ListForm">
         <div class="search">
             <ul>
                 <li>
                ...
                <s:if test="#request.teacherList!=null && #request.teacherList.size()>0">
                    <s:iterator value="#request.teacherList" var="teacher">
                        <tr>
                            ...
                            <td align="center" class="hui oprate_con" style="min-width:80px"><a href="<%=basePath%>/system/teacher_stuedit.do?teaId=<s:property value='#teacher.teaId'/>&currentPage=${request.currentPage}" class="blue" >查看</a>
