...
<div class="cont">
    <h1 class="seth">指导教师</h1>
    <div class="nav_list">
        <ul>
            <li><a href="<%=basePath%>/system/teacher_stulist.do"><b>主页</b></a> </li>
    ...
    <form name="theForm" id="theForm" action="<%=basePath%>/system/teacher_stusave.do" method="post" enctype="multipart/form-data">
