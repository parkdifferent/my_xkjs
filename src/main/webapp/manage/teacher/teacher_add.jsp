...
<div class="cont">
    ...
    <form name="theForm" id="theForm" action="<%=basePath%>/system/teacher_save.do" method="post" enctype="multipart/form-data">
                ...
                <ul class="set1">
                    ...
                    <li><span class="webname">
                        <select name="academe" id="academe">
                            <option value="" ${request.teacher.academe ==null?'selected':''}>请选择...</option>
        ...
        <%--<input name="brief" type="text" id="brief" value="<s:property value="#request.teacher.brief"/>" />--%>
                        <textarea name="brief" cols="100" rows="8" style="width:700px;height:250px;"><s:property value="#request.teacher.brief"/></textarea>
        ...
        <div class="submit">
   			...
   			<input name="save" type="button" value="提交" onclick="saveForm()" />
   			 <input name="teaId" type="hidden" id="teaId" value="<s:property value="#request.teacher.teaId"/>" />
  				...
  				<input name="list_url" type="hidden" id="list_url" value="<%=basePath%>/system/teacher_list.do" />
 				 <input name="add_url" type="hidden" id="add_url" value="<%=basePath%>/system/teacher_add.do" />
