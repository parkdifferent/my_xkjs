...
<%-- <div class="content">
     <div class="content_box">
         <div class="content_bar">
             <div class="right_competition" id="bar_online" style="display:none"><a id="speak" onclick="open_im('','$!webPath','plat');" href="javascript:void(0);">在线客服</a></div>
...
<div class="cont">
    ...
    <FORM name="ListForm" id="ListForm"  action="<%=basePath%>/system/competition_list.do" method="post">
        <div class="search">
            <%--<span>
